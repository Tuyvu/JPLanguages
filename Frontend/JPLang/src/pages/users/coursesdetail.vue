<template>
 <body class="bg-white text-dark">
    ...
    <modelCoursesUser :show="showCoursesModalUser" @close="showCoursesModalUser = false" />
</body>
</template>
<script setup>
...
import modelCoursesUser from '../../components/modelCoursesUser.vue';
...
const showCoursesModalUser = ref(false);
