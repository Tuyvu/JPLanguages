<template>
        ...
        <div class="module-letters-content">
          <div class="module-letters-block" style="display: block;">
            <ul class="letters-list">
              <template v-for="(item, index) in letterskatakana" :key="index">
                <li class="module-modal" v-if="item.name !== '0'" @click="showModal" :data-id="item.number - 1">
                  <img :src="'/src/assets/images/letters/kana/' + item.name + '.png'" :alt="item.name">
                </li>
                <li v-else></li>
              </template>
            </ul>
             ...
             <ul class="letters-list">
                <template v-for="(item2, index1) in lettershiragana2" :key="index1">
                  <li class="module-modal" v-if="item2.number < 72" @click="showModal" :data-id="item2.number - 1">
                    <img :src="'/src/assets/images/letters/kana/' + item2.name + '.png'" :alt="item2.name">
                  </li>
          ...
          <div class="swiper-container">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                ...
                <figure>
                  <img :src="`/src/assets/images/letters/detail/kana/${selectedLetter.name}.png`" :alt="selectedLetter.name">
                </figure>
              </div>
            </div>
  ...
  import { letterskatakana, lettershiragana2 } from "../constants/index";
  ...
  function findletter(modalId) {
    selectedLetter.value = letterskatakana.find((item) => item.number === modalId + 1);
