                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="card">
                            ...
                            <div class="card-body pt-0"> 
                                ...
                                @endif                                   
                                <form class="my-4" action="{{ route('postlogon') }}" method="POST">       
                                    @csrf     
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="password" name="password" id="userpassword" placeholder="Enter password">                            
                                    </div><!--end form-group--> 
