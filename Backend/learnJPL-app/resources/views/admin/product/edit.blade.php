                      ...
                      @csrf
                        <div class="box-body">
                            ...
                            <div class="form-group @error('production_date') has-error @enderror">
                                ...
                                <input type="text" class="form-control" id="production_date" name="production_date" placeholder="Ngày sản xuất (DD-MM-YYYY)" value="{{ old('production_date',$product->production_date) }}">
                            ...
                            <div class="form-group @error('expiration_date') has-error @enderror">
                                ...
                                <input type="text" class="form-control" id="expiration_date" name="expiration_date" placeholder="Hạn sử dụng (DD-MM-YYYY)" value="{{ old('expiration_date',$product->expiration_date) }}">
                                ...
                                <div class="variant-group my-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control mt-1" name="type" value="{{ old('type',$product->type) }}" placeholder="Tên biến thể">
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="variant-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="variant_name[]" value="{{ old('variant_name',$variant->variant_name) }}" placeholder="Tên biến thể">
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label for="variant_price">Giá biến thể</label>
                                                    <input type="text" class="form-control" name="variant_price[]" value="{{ old('variant_price',$variant->variant_price) }}" placeholder="Giá biến thể" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="variant_price">Giá KM biến thể</label>
                                                    <input type="text" class="form-control" name="variant_sale_price[]" value="{{ old('variant_sale_price',$variant->variant_sale_price) }}" placeholder="Giá KM biến thể" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                                </div>
                                            </div>    
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control mb-2" name="proportion[]" value="{{ old('proportion',$variant->proportion) }}" placeholder="Số lượng so với loại ban đầu" onkeypress="return event.charCode >= 46 && event.charCode <= 57">
                                        </div>
