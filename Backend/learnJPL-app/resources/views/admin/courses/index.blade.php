            ...
            <div class="ibox-content">
                ...
                <div class="row">
                    <div class="col-sm-9 m-b-xs">
                        <a href="{{route('courses.create')}}" class="btn btn-success">Thêm mới danh mục</a>
                        <a href="{{route('courses.restore')}}" class="btn btn-success"><i class="fa fa-trash"></i></a>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td><a href="{{Route('courses.edit',$item->id)}}" class="btn btn-success">sửa</a></td>
                            <td>
